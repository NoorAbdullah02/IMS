            ...
            ${!isPaid ? `
                <div class="bg-gradient-to-br from-rose-900/40 to-slate-900 border-2 border-rose-500/20 p-8 rounded-[2.5rem] flex items-center justify-between mb-8 shadow-2xl relative overflow-hidden group">
                    ...
                    <div class="flex items-center space-x-6 relative z-10">
                        ...
                        <div>
                            <h3 class="text-xl font-black text-white tracking-tight">Institutional Alert: Payment Sequence Incomplete</h3>
                            <p class="text-slate-400 font-medium">Your course registration protocol is currently locked. Financial settlement required.</p>
                        </div>
                    </div>
                </div>
            ` : isRegistered ? `
                <div class="bg-gradient-to-br from-emerald-900/40 to-slate-900 border-2 border-emerald-500/20 p-8 rounded-[2.5rem] flex items-center justify-between mb-8 shadow-2xl relative overflow-hidden group">
                    ...
                    <div class="flex items-center space-x-6 relative z-10">
                        ...
                        <div>
                            <h3 class="text-xl font-black text-white tracking-tight">Academic Access Verified</h3>
                            <p class="text-slate-400 font-medium">Your account is in good standing. All academic systems have been provisioned.</p>
                        </div>
                    </div>
                </div>
            ` : `
                <div class="bg-gradient-to-br from-indigo-900/40 to-slate-900 border-2 border-indigo-500/20 p-8 rounded-[2.5rem] flex items-center justify-between mb-8 shadow-2xl relative overflow-hidden group">
                     ...
                     <div class="flex items-center space-x-6 relative z-10">
                        ...
                        <div>
                            <h3 class="text-xl font-black text-white tracking-tight">Fee Settlement Verified</h3>
                            <p class="text-slate-400 font-medium">Payment confirmed. Register for Spring 2025 to activate your profile.</p>
                        </div>
                    ...
                    <div class="bg-gradient-to-br from-slate-800 to-slate-900 p-8 rounded-[3rem] shadow-2xl border-2 border-white/5 relative overflow-hidden">
                        ...
                        <div class="space-y-8 relative z-10">
                            ...
                            <div class="pt-8 border-t border-white/5">
                                <span class="text-[10px] font-black text-slate-400 block mb-2 uppercase tracking-widest">Semester Installment</span>
                                <span class="text-2xl font-black text-indigo-400">${feeStructure.perSemesterFee.toLocaleString()} <span class="text-[10px] font-bold text-slate-500 ml-1">BDT / Sem</span></span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <div class="w-full py-10 border-2 border-dashed border-white/10 rounded-2xl flex flex-col items-center justify-center bg-white/5 group-hover:border-indigo-500 group-hover:bg-indigo-500/5 transition-all">
                                        ...
                                        <p class="text-[10px] font-black text-slate-500 uppercase tracking-widest group-hover:text-indigo-400 transition-colors">Attach Audit Reference</p>
                                    </div>
                                </div>
                            </div>
